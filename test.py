...
from prediction import func_pre
...
for i_file in files[: file_num + 1]:
    ...
    (cut_var_pred, cut_var_true, cut_nino_pred, cut_nino_true,) = func_pre(   # cut_nino_pred(20,473) cut_nino_true(473) cut_var_pred(20,473,9,51,120) cut_var_true(473,9,51,120)
        mypara=mypara,
        adr_model=i_file,
    ...
    # -----------
    cut_nino_true_jx = deepcopy(cut_nino_true[(24 - lead_max + 1) :])    # (468)
    cut_nino_pred_jx = deepcopy(cut_nino_pred[:, (24 - lead_max + 1) :])     # (20,468)
    ...
    # pre_nino_tg (39,12,20)
    # real_nino (39,12)
    # pre_nino_st (39,12,20)
    for l in range(lead_max):
    ...
    plt.tight_layout()
    plt.savefig("./test/test_skill_tf50_0.0001.png")
    # plt.show()
    print("*************" * 8)
